...
You can do view() function in the console and it will load the dataset
in a separate window. Try to avoid doing it from up here because it
might screw up knitting process.
...
Go to ‘?read\_excel’ for more help
